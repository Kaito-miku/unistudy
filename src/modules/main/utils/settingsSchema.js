...
const DEFAULT_SETTINGS = Object.freeze({
    ...
    guideModel: '',
    defaultModel: 'Pro/moonshotai/Kimi-K2.6',
    followUpDefaultModel: 'Qwen/Qwen3.5-9B',
    topicTitleDefaultModel: 'Qwen/Qwen3.5-9B',
    lastModel: '',
    kbBaseUrl: 'https://api.uniquest.top/v1',
    kbApiKey: 'sk-TtwYTSOeumdwgYVLPM8ul0LcJXU7Cc4uCiiYEQQfjavRin8E',
